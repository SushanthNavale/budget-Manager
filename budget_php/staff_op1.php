...
<tr>
<td><font size="3" color="maroon" font="Comic Sans MS "> Enter The Particular Financial Year Correctly </font></td>
</tr>
<table style="background-color:grey" align="center">
<tr>
<td><font size="5" color="maroon" font="Comic Sans MS ">Faculty Name:</font></td><td><input type="text" name="facname" value="<?php echo@$uname;?>"required="true"></td>
<td><font size="5" color="maroon" font="Comic Sans MS ">Financial Year:</font></td><td><input type="text" name="fin" required="true"></td>
<td><font size="5" color="maroon" font="Comic Sans MS ">Budget Proposed:</font></td><td><input type="text" name="budprop" required="true"></td>
</tr>
</table>
...
<td><font size="5" color="maroon" font="Comic Sans MS ">Faculty Name:</font></td><td><input type="text" name="facname1" value="<?php echo@$uname;?>"required="true"></td>
<td><font size="5" color="maroon" font="Comic Sans MS ">Head:</font></td><td><input type="text" name="head1" required="true"></td>
<td><font size="5" color="maroon" font="Comic Sans MS ">Budget Proposed:</font></td><td><input type="text" name="budprop1" required="true"></td>
</tr>
</table>
...
$year=$_POST['fin'];
$fac_name=$_POST['facname'];
$bud=$_POST['budprop'];
$sql = "INSERT INTO fac_bud ( fac_name,finan_year,dept_name,budget) VALUES ('$fac_name','$year','$head','$bud')";
...
$bud=$_POST['budprop1'];
$head=$_POST['head1'];
$sql = "UPDATE `fac_bud` SET `fac_name`='$fac_name',`dept_name`='$head',`budget`='$bud' WHERE dept_name='$head'";
if ($mysqli->query($sql) === TRUE) 
{
...
echo "<th> <font size='3' color='black'>proposed Budget</font></th>";
