...
<td>
<font size="4" color="Black"><b> Name:</b></font></td><td><input type="text" name="name" value="<?php echo@$uname;?>" required="true"></td>
<td>
...
$phno=$_POST['phno'];
$mail=$_POST['mail'];
$sql = "INSERT INTO details(img,name,contact,email) VALUES ('$image','$name','$phno','$mail')";
...
echo "<tr>";
echo "<th> <font size='3' color='black'>Faculty Image</font></th>";
...
echo "</tr>";
echo" <tr>";
 echo "<td><img src='uploads/$row[0].jpg' height='150px' width='300px'></td>";
echo"<td>".$row['name']."</td>";
