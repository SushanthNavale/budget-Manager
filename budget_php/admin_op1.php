...
<tr>
<td>
<font size="5" color="Black"><b>Department Name:</b></font></td><td><input type="text" name="dept" required="true"></td>
<td>
<font size="5" color="Black"><b>Budget Alloted:</b></font></td><td><input type="text" name="bud" required="true"></td>
</tr>
</table>
<table style="background-color:grey" align="center">
<tr>
...
$dept=$_POST['dept'];
$bud=$_POST['bud'];
$sql = "INSERT INTO department ( dept,bud) VALUES ('$dept','$bud')";
...
echo "<th> <font size='3' color='black'>Alloted Budget</font></th>";
while($row = $result->fetch_array())
{
echo "</tr>";
echo" <tr>";
echo"<td font color='black'>".$row['Sl No']."</td>";
echo"<td>".$row['dept']."</td>";
echo"<td>".$row['bud']."</td>";
echo "</tr>";
}
